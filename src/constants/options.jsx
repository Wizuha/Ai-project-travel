...
export const AI_PROMPT = "Générez un plan pour le lieu : {location}, pour {totalDays} jour pour {traveler} avec un budget {budget}, donne moi une liste d'otpions d'hotels avec le nom de l'hôtel,le  prix a payer par nuit de l'hôtel, l'url de l'image de l'hôtel, les coordonnées géographiques,l'adresse de l'hôtel,l'évaluation, les descriptions et les suggestions itinéraires avec le nom du lieu, les détails du lieu, l'url de l'image du lieu, les coordonnées géographiques, les prix des billets, le temps de voyage entre chaque lieu pour {totalDays} jours avec chaque plan journalier en format JSON "